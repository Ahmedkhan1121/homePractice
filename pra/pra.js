...
for (var i = 1; i <= 10; i++) {
    console.log("5 x ".concat(i, " = ").concat(i * 5));
}
// Question #2 
...
var maxValueInArr = Math.max.apply(Math, arr1); //[2,4,12,5] =>  2,4,12,5
...
var multipleTyp = ['Ahmed', 3, true, undefined];
var savemultipleTyp = multipleTyp.filter(function (e, i, a) {
